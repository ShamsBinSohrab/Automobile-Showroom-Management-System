...
<?php
	...
	$row=update_recsold_entry_id($entry_id);
	$chassis_no=update_recsold_chassis_no($entry_id);
...
<html>
	...
	<body class="update_rec_sold no_bg">
		<hr/>
        ...
        <p id = "notification"></p>
            ...
            <form method ="POST" id = "update_form">
                ...
                <tr id = "chassis">
				  ...
				  <input type='text' name='chassis_no' value="<?=$chassis_no['chassis_no']?>"
				  </td>
                </tr>
                <tr>
                    <td colspan = "2">
